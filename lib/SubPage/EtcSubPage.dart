          ...
          Row(
            ...
            children: [
              ...
              OutlinedButton(
                ...
                child: Text("관심분야 수정",style: TextStyle(fontSize: 10),),
              ),
              SizedBox(width: 10,),
              ElevatedButton(
                style: ElevatedButton.styleFrom(primary: Colors.red),
                child: Text("로그아웃",style: TextStyle(fontSize: 10),),
                onPressed: () async {
          ...
          Row(
            children: [
              Padding(
                ...
                child: Text("나의 소모임",textAlign: TextAlign.start,),
              ),
            ],
          ),
